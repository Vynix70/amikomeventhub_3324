        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{url('admin/categories')}}"
                ...
                <svg class="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a1.993 1.993 0 012-1.414h3a1.993 1.993 0 012 1.414v2a2 2 0 01-2 2h-3a2 2 0 01-2-2v-2z">
                    </path>
                </svg>
                Kelola Kategori
            </a>
