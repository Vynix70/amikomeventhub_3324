...
<main class="max-w-3xl mx-auto px-6 py-20 text-center">
    ...
    <h2 claas="text-2xl font-black mb-2">Selesaikan Pembayaran</h2>
    ...
    <button id="pay-button" class="w-full py-5 bg-indigo-600 text-white rounded-2x; font-black text-xl shadow-xl shadow-indigo-200 hover:bg-indogp-700 transition animate-bounce-in">
        Bayar Sekarang
    </button>
</main>
